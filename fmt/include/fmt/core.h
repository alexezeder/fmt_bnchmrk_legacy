...
#  endif
#endif
#ifndef FMT_INSTANTIATION_DEF_API  // msvc marks dllexport at the definition
                                   // itself.
#  ifndef _MSC_VER
...
#if __cplusplus >= 201703L  // C++17's char_traits::compare() is constexpr.
  constexpr
#endif
      int
...
#endif
      friend bool
      operator==(basic_string_view lhs, basic_string_view rhs) {
...
template <typename Context> struct arg_mapper {
  ...
  template <typename T, FMT_ENABLE_IF(is_named_arg<T>())>
